...
$('.musicbox .play').onclick = function(){
    if(audio.paused){
      audio.play()
      this.querySelector('.iconfont').classList.add('icon-begin')
      this.querySelector('.iconfont').classList.remove('icon-pause')
    }else{
      audio.pause()
      this.querySelector('.iconfont').classList.remove('icon-begin')
...
$('.musicbox .bar').onclick = function(e){
    var persent = e.offsetX/parseInt(getComputedStyle(this).width)
